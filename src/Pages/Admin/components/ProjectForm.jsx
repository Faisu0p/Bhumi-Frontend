...
const ProjectForm = ({ onNext }) => {
  ...
  const [projectData, setProjectData] = useState({
    ...
    totalTowers: '5',
    totalResidentialUnits: '200',
    totalCommercialUnits: '50',
    projectType: 'Residential',
    sectorBriefing: 'High-end luxury residential project.',
    projectBriefing: 'A premium residential complex with modern amenities.',
    projectIsVerified: true,
    projectMedia: 'https://example.com/project-media',
  });
